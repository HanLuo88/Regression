...
p1235_M2 = pd.read_csv('p1235_M2_v2_selection.csv')
p1235_M2 = p1235_M2.iloc[:, 1:]
print(p1235_M2.columns)
p3487_M2 = pd.read_csv('p3487_M2_v2_selection.csv')
p3487_M2 = p3487_M2.iloc[:, 1:]
p5865_M2 = pd.read_csv('p5865_M2_v2_selection.csv')
p5865_M2 = p5865_M2.iloc[:, 1:]
p8730_M2 = pd.read_csv('p8730_M2_v2_selection.csv')
p8730_M2 = p8730_M2.iloc[:, 1:]

p124_M2 = pd.read_csv('p124_M2_v2_selection.csv')
p124_M2 = p124_M2.iloc[:, 1:]
p3297_M2 = pd.read_csv('p3297_M2_v2_selection.csv')
p3297_M2 = p3297_M2.iloc[:, 1:]
p6658_M2 = pd.read_csv('p6658_M2_v2_selection.csv')
p6658_M2 = p6658_M2.iloc[:, 1:]
p282441_M2 = pd.read_csv('p282441_M2_v2_selection.csv')
...
result = pd.read_csv('automated_algorithmen.csv')
result = result.iloc[:, 1:]
result.at[7, 'Logistic_Regression'] = precisionlr
result.to_csv('automated_algorithmen.csv')
...
result = pd.read_csv('automated_algorithmen.csv')
result = result.iloc[:, 1:]
result.at[7, 'Decision_Tree'] = precisiondc
result.to_csv('automated_algorithmen.csv')
...
result = pd.read_csv('automated_algorithmen.csv')
result = result.iloc[:, 1:]
result.at[7, 'Random_Forest'] = precisionrf
result.to_csv('automated_algorithmen.csv')
...
result = pd.read_csv('automated_algorithmen.csv')
result = result.iloc[:, 1:]
result.at[7, 'ADABoost'] = precisionada
result.to_csv('automated_algorithmen.csv')
...
result = pd.read_csv('automated_algorithmen.csv')
result = result.iloc[:, 1:]
result.at[7, 'XGBoost'] = precisionxg
result.to_csv('automated_algorithmen.csv')
...
# p1235_M2.to_csv('p1235_M2_v2_selection.csv')
# p3487_M2.to_csv('p3487_M2_v2_selection.csv')
# p5865_M2.to_csv('p5865_M2_v2_selection.csv')
# p8730_M2.to_csv('p8730_M2_v2_selection.csv')
# p124_M2.to_csv('p124_M2_v2_selection.csv')
# p3297_M2.to_csv('p3297_M2_v2_selection.csv')
# p6658_M2.to_csv('p6658_M2_v2_selection.csv')
# p282441_M2.to_csv('p282441_M2_v2_selection.csv')