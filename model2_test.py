...
############################################################################################################################
    ...
    def test_Model2_Classification(self):
        #Model 2 ist multiclass.
        intervalle = [(-520, -200), (-199, 0), (1, 14), (15, 30), (31, 60),
                      (61, 90), (91, 120), (121, 180), (181, 365), (366, 850), (851, 1650)]
        print(intervalle)
        ...
        notBoosted = True
        if notBoosted:
            inputdataset = 'model2_Classificationtable_intervalstatus_TMP.csv'
            ...
            inputdataset = 'medDataCopy_model2_Features_Selected.csv'
        ...
        medDatamodel2 = pd.read_csv(inputdataset)
        ...
        precisionKNN = precision_score(
            knnYpred, med_class_test_array, average='macro')
        recallKNN = recall_score(
            knnYpred, med_class_test_array, average='macro')
        ...
        precisionRF = precision_score(
            rfPred, med_class_test_array, average='macro')
        ...
        adamodel_accuracy = accuracy_score(
            med_class_test_model2, adamodel_prediction)
        ...
        plot_importance(xgmodel.get_booster(
